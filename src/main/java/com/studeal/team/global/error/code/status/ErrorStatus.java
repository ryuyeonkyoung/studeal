...
public enum ErrorStatus implements BaseErrorCode {
    ...
    TEACHER_NOT_FOUND(HttpStatus.BAD_REQUEST, "TEACHER_400_01", "강사가 없습니다."),
    STUDENT_NOT_FOUND(HttpStatus.BAD_REQUEST, "STUDENT_400_01", "학생이 없습니다."),
    ...
    BOARD_STUDENT_FORBIDDEN(HttpStatus.FORBIDDEN, "BOARD_403_02", "학생은 게시글을 올릴 수 없습니다."),
