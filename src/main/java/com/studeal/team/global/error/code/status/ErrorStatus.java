...
public enum ErrorStatus implements BaseErrorCode {
  ...
  // 가장 일반적인 응답
  _INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "COMMON_500_01",
      "서버 에러, 관리자에게 문의 바랍니다."),
  ...
  COURSE_ALREADY_ENROLLED_BY_ANOTHER_USER(HttpStatus.BAD_REQUEST, "COURSE_400_04",
      "다른 사용자가 수강중인 코스입니다."),
  ...
  ENROLLMENT_INVALID_NEGOTIATION_STATUS(HttpStatus.BAD_REQUEST, "ENROLLMENT_400_03",
      "협상이 성공 상태가 아닙니다.");
