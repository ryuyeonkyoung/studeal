...
public class EnrollmentCommandService {
  ...
  /**
   * 수강 신청 생성 메서드 NegotiationService에서 호출될 때 트랜잭션 전파를 위해 REQUIRED 설정 (기본값)
   */
  ...
  public EnrollmentResponseDTO updateStatus(Long enrollmentId,
      EnrollmentRequestDTO.StatusUpdateRequest request) {
    // 수강 신청 확인
   ...
   */
  private void validateStatusTransition(EnrollmentStatus currentStatus,
