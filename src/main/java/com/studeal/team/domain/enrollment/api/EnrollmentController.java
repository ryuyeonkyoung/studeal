...
public class EnrollmentController {
    ...
    @Operation(
            ...
            description = "경매 종료 후, 최고가를 부른 학생과 선생님을 연결하는 API입니다. 이를 통해 학생은 낙찰받은 수업을 결제하여 거래를 성사하거나, 거절하여 최종 낙찰을 포기할 수 있습니다.")
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "ENROLLMENT4001", description = "이미 수강 신청이 존재합니다.", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
