...
/**
 * 게시판 명령 서비스 클래스 생성, 수정, 삭제 작업을 담당합니다.
 */
@Slf4j
@Service
...
public class BoardCommandService {
  ...
  public BoardResponseDTO.DetailResponse createBoard(Long teacherId,
   ...
   */
  @PreAuthorize("hasRole('TEACHER')")
  public BoardResponseDTO.DetailResponse updateBoard(Long boardId, Long teacherId,
