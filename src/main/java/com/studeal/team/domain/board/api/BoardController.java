...
/**
 * 게시판 API 컨트롤러 과외 모집 게시글 관련 엔드포인트 제공
 */
...
public class BoardController {
  ...
  public ApiResponse<BoardResponseDTO.DetailResponse> updateBoard(
    ...
    BoardResponseDTO.DetailResponse response = boardCommandService.updateBoard(boardId, teacherId,
        request);
    return ApiResponse.onSuccess(response);
  }
  ...
  public ApiResponse<BoardResponseDTO.CursorPageResponse> getBoardsByCursor(
    ...
    BoardResponseDTO.CursorPageResponse response = boardQueryService.getBoardsByCursor(cursorId,
        size);
    return ApiResponse.onSuccess(response);
  }
  ...
  public ApiResponse<BoardResponseDTO.SearchPageResponse> searchBoards(
    ...
    Pageable pageable = PageRequest.of(page, size);
    BoardResponseDTO.SearchPageResponse response = boardQueryService.searchBoards(searchType,
        keyword, pageable);
    return ApiResponse.onSuccess(response);
  }
}