...
/**
 * 게시판 응답 DTO 클래스 모든 게시판 관련 응답 DTO들의 컨테이너입니다.
 */
@Schema(description = "게시판 응답 DTO")
public class BoardResponseDTO {

  /**
   * 게시글 상세 응답 DTO 게시글 조회 시 사용
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 게시글 목록 항목 DTO 게시글 목록 조회 시 사용되는 개별 게시글 정보
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 게시글 목록 항목 응답 DTO 게시글 목록 조회 시 사용
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 게시글 페이지 응답 DTO 페이지네이션 정보를 포함한 게시글 목록 조회 시 사용
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 선생님 상세 조회 응답 DTO 게시글 상세 조회 시 선생님 정보 포함하여 조회
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 학생 상세 조회 응답 DTO 게시글 상세 조회 시 학생에게 필요한 정보 포함
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 입찰 응답 DTO 선생님 상세 조회 시 입찰 정보 포함
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 커서 기반 페이징용 게시글 목록 항목 DTO 커서 기반 게시글 목록 조회 시 사용되는 개별 게시글 정보
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 오프셋 기반 페이징용 게시글 목록 항목 DTO 오프셋 기반 게시글 목록 조회 시 사용
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 오프셋 기반 페이지 응답 DTO 오프셋 페이지네이션 정보를 포함한 게시글 목록 조회 시 사용
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 커서 기반 페이징 응답 DTO 커서 기반 페이징을 위한 응답
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 게시글 검색 결과 응답 DTO 검색 결과는 페이징 처리되어 반환됩니다.
   */
  @Getter
  @Builder
  @NoArgsConstructor
  ...
  /**
   * 게시글 검색 결과 아이템 DTO 검색 결과의 각 게시글 항목을 나타냅니다.
   */
  @Getter
  @Builder
  @NoArgsConstructor
